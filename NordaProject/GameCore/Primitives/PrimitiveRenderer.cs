...
{
    private static int CreateDisplayList(Action<Triangle, Vector2[]> renderAction, int range = 1)
    {
        return 0;
    }
    ...
    public static void CreateStripedTriangle(Triangle baseTriangle, Vector2[] vertices)
    {
